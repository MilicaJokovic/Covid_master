...
for index = param_index_perm_vec
 ...
 save ElNet_early_save MSE_alpha_lambda_mat x y y_names
...
save ElasticNet_sparse_Round_1 B FitInfo x y x_names MSE_alpha_lambda_mat alpha_max_sparse lambda_max_sparse MSE_max_sparse_test EN_Results_fin
